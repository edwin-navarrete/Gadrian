...
This script creates an extension method for the GFGrid class, which means it
adds a new method to the class without the need to alter the source code of the
class. Once declared you can use the method just like any normal class method.

One of the design principles behind Grid Framework says that the GFGrid class
and all its methods are abstract and that the exact implementation lies in the
sublasses. However, since extensions methods are static they cannot be
...
implementation based on the exact type of grid. Note that those functions are
...
public static class GFGridLightsExampleExtensions{
	...
	/// <summary>Whether two points are adjacent in a grid.</summary>
	/// <param name="theGrid">Basis for comparison.</param>
	/// <param name="position">First coordinate.</param>
	/// <param name="reference">Second coordinate.</param>
